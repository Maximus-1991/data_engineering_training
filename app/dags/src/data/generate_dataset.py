...
def generate_train_test_val_dataset(dataset):
    ...
    logging.info("training set size: data = {}, labels = {}".format(X_train.shape, y_train.shape))
    logging.info("validation set size: data = {}, labels = {}".format(X_val.shape, y_val.shape))
    logging.info("Test set size: data = " + str(X_test.shape) + ", labels = " + str(y_test.shape))